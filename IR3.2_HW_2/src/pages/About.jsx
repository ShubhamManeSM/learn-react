    ...
    return (
      <main className="container py-4">
        ...
        <p>
          ...
          travel and experience the world. Our mission is to create a world where
          anyone can belong anywhere, and we strive to make travel accessible,
          authentic, and unforgettable for everyone.
        </p>
        <p>
        ...
        <p>
          Join us on the journey as we redefine travel and hospitality, one
          experience at a time. Whether you're a host or a guest, we invite yout
          ot be a part of our vibrant community and embark on extraordinary
